 ...
 */
final class Version20260505100153 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE conversation ADD CONSTRAINT `FK_8A8E26E95DC4D72E` FOREIGN KEY (interlocuteur_id) REFERENCES user_profile (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
